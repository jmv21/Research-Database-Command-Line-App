...
Control {
    ...
    property bool contentItemHasActiveFocus: false
    ...
    readonly property T.SpinBox spinBoxItem: contentItem
    ...
    contentItem: CustomMaterialSpinBox {
        ...
        Component.onCompleted: {
            control.contentItemHasActiveFocus = Qt.binding(function(){return activeFocus})
        }
    }
    ...
    */
    ...
    /**
     * Executes the specified action with the provided arguments.
     *
     * @param action The type of action to execute. Provides both the action type
     *        and the arguments.
     *
     * This method acts as a central dispatcher for different actions. It takes an
     * enum representing the action type and dynamically calls the corresponding
     * method, preparing the necessary arguments.
     *
     * For example, if action is ActionType::CreateStudy, this method will call
     * postStudy(...) with the provided args.
     *
     */
